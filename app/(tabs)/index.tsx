    ...
    <View style={styles.container}>
      ...
      <View style={[styles.floatingTopContainer, { paddingTop: insets.top + (Platform.OS === 'ios' ? 4 : 8) }]}>
        ...
        <View style={styles.topActionRow}>
          {/* TOP LEFT 3 WORKING BUTTONS */}
          <View style={styles.topPillSegment}>
            {/* Button 1: Layers Switcher */}
            <TouchableOpacity
              style={[styles.topPillBtn, mapType !== 'standard' && styles.topPillBtnActive]}
              onPress={handleToggleMapLayers}
              activeOpacity={0.8}
            >
              <Layers size={16} color={mapType !== 'standard' ? '#FFFFFF' : COLORS.primary} />
            </TouchableOpacity>

            {/* Button 2: GPS Re-center */}
            <TouchableOpacity
            ...
            {/* Button 3: Urgent Hazards Filter Toggle */}
            <TouchableOpacity
              style={[styles.topPillBtn, urgentOnly && styles.topPillBtnActiveUrgent]}
              onPress={handleToggleUrgent}
              activeOpacity={0.8}
            >
              <Flame size={16} color={urgentOnly ? '#FFFFFF' : '#EF4444'} />
            </TouchableOpacity>
          </View>

          {/* TOP RIGHT 3-DOTS STATUS DROPDOWN SELECTOR */}
